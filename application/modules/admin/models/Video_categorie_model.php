...
class Video_categorie_model extends CI_Model
{

    public $table = 'video_categorie';
    public $id = 'videoId';
    public $order = 'DESC';
...
/* End of file Video_categorie_model.php */
/* Location: ./application/models/Video_categorie_model.php */
