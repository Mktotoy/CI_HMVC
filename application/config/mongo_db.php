...
$config['mongo_db']['default']['hostname'] = '164.132.227.93';
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'leanroot';
$config['mongo_db']['default']['password'] = 'test';
$config['mongo_db']['default']['database'] = 'learnplateform';
$config['mongo_db']['default']['db_debug'] = TRUE;
$config['mongo_db']['default']['return_as'] = 'array';
$config['mongo_db']['default']['write_concerns'] = (int)1;
$config['mongo_db']['default']['journal'] = TRUE;
$config['mongo_db']['default']['read_preference'] = array('useCursor' => FALSE);
